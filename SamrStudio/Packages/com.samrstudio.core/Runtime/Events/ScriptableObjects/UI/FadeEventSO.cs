...
{
    [CreateAssetMenu(menuName = "SamrStudio/Events/UI/Fade Event")]
    public class FadeEventSO : ScriptableObject
    {
        public UnityAction<float, Color> OnEventRaised;
        ...
        private void Fade(float duration, Color color)
        {
            if (OnEventRaised != null)
                OnEventRaised.Invoke(duration, color);
        }
    }
}
